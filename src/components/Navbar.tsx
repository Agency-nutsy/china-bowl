    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="font-display text-2xl font-bold">
          <span className={showSolid ? "text-primary" : "text-primary-foreground"}>China</span>
          <span className={showSolid ? "text-foreground" : "text-primary-foreground/80"}> Bowl</span>
        </Link>
          ...
          >
            <ul className="flex flex-col p-4 gap-1">
              ...
              >
                <a
                  href={`tel:${PHONE}`}
                  className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-primary text-primary-foreground text-sm font-semibold text-center mt-2"
                >
                  <Phone size={16} />
                  Call Us
                </a>
